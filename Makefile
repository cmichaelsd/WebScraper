...
.PHONY: k8s-start k8s-build k8s-deploy k8s-up k8s-down k8s-status \
        ...
        k8s-aws-auth k8s-aws-deploy k8s-aws-status \
...
## Print the ALB hostname for the API
k8s-aws-url:
	@terraform -chdir=$(INFRA_DIR) output -raw alb_dns_name
	@echo ""
